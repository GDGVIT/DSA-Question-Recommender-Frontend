...
export default function Page () {
  return (
    <section className='flex flex-col items-center w-full'>
      <h1 className='text-3xl font-bold text-cream mb-4'>Make an account</h1>
      <h3 className='text-cream mb-8'>Please enter your details to Sign Up</h3>
      ...
      <div className='mt-10 text-cream'>
        Already have an account? <a className='text-auth-red' href='/auth/register'>Sign In</a>
      </div>
    </section>
  )
}
